...
public class Emp {
	...
	public Emp(Integer empId, String empName, String empLoginName, String empPwd, String empEmail, String empPhone,
			Double empSalary, Date empHiredate, Dept dept, Job job, String empInfo, String empPic) {
		super();
		this.empId = empId;
	...
	public Emp(String empName, String empLoginName, String empPwd, String empEmail, String empPhone, Double empSalary,
			Date empHiredate, Dept dept, Job job, String empInfo, String empPic) {
		super();
		this.empName = empName;
		this.empLoginName = empLoginName;
		this.empPwd = empPwd;
	...
	public Emp(String empName, String empLoginName, String empPwd, String empEmail, String empPhone, Double empSalary,
			Date empHiredate, Dept dept, Job job, String empInfo) {
		super();
		this.empName = empName;
		this.empLoginName = empLoginName;
		this.empPwd = empPwd;
	...
	public Emp(Integer empId, String empName, String empLoginName, String empPwd, String empEmail, String empPhone,
			Double empSalary, Date empHiredate, Dept dept, Job job, String empInfo) {
		super();
		this.empId = empId;
		this.empName = empName;
		this.empLoginName = empLoginName;
	...
	public String toString() {
		return "Emp [empId=" + empId + ", empName=" + empName + ", empLoginName=" + empLoginName + ", empPwd=" + empPwd
				...
				+ empHiredate + ", dept=" + dept + ", job=" + job + ", empInfo=" + empInfo + ", empPic=" + empPic + "]";
	}
